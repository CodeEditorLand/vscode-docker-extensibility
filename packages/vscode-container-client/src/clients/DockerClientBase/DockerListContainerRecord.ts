...
export function isDockerListContainerRecord(
	maybeContainer: unknown,
): maybeContainer is DockerListContainerRecord {
...
export function normalizeDockerListContainerRecord(
	container: DockerListContainerRecord,
	strict: boolean,
): ListContainersItem {
...
export function normalizeContainerState(
	container: Pick<DockerListContainerRecord, "State" | "Status">,
): string {
	if (container.State) {
