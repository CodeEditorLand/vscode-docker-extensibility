...
export class Powershell extends Shell {
	...
	public override goTemplateQuotedString(
		arg: string,
		quoting: ShellQuoting,
	): ShellQuotedString {
		switch (quoting) {
	...
	public override getShellOrDefault(
...
export async function spawnStreamAsync(
	...
	return new Promise<void>((resolve, reject) => {
		const disposable = cancellationToken.onCancellationRequested(() => {
			...
			reject(
				new CancellationError("Command cancelled", cancellationToken),
			);
		});
