...
export function isDockerInspectVolumeRecord(
	maybeVolume: unknown,
): maybeVolume is DockerInspectVolumeRecord {
	return true;
}

export function normalizeDockerInspectVolumeRecord(
	volume: DockerInspectVolumeRecord,
): InspectVolumesItem {
