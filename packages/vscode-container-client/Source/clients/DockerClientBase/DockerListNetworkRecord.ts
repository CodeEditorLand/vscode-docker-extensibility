...
export function isDockerListNetworkRecord(
	maybeNetwork: unknown,
): maybeNetwork is DockerListNetworkRecord {
...
export function normalizeDockerListNetworkRecord(
	network: DockerListNetworkRecord,
): ListNetworkItem {
