...
export function isContainerOS(
	maybeContainerOS: unknown,
): maybeContainerOS is ContainerOS {
...
export type RunContainerMount = RunContainerBindMount | RunContainerVolumeMount;
...
type InspectContainersCommand = {
	...
	): Promise<PromiseCommandResponse<Array<InspectContainersItem>>>;
};
...
type ListVolumesCommand = {
	...
	): Promise<PromiseCommandResponse<Array<ListVolumeItem>>>;
};
...
type InspectNetworksCommand = {
	...
	): Promise<PromiseCommandResponse<Array<InspectNetworksItem>>>;
};
...
type ListContextsCommand = {
	...
	): Promise<PromiseCommandResponse<Array<ListContextItem>>>;
};
...
type InspectContextsCommand = {
	...
	): Promise<PromiseCommandResponse<Array<InspectContextsItem>>>;
};
...
type ListFilesCommand = {
	...
	): Promise<PromiseCommandResponse<Array<ListFilesItem>>>;
};
