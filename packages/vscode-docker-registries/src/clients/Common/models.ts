...
export interface CommonRegistryItem
...
export function isCommonRegistryItem(
	maybeCommonRegistryItem: unknown,
): maybeCommonRegistryItem is CommonRegistryItem {
	return (
		!!maybeCommonRegistryItem &&
		typeof maybeCommonRegistryItem === "object" &&
...
export function isRegistryRoot(
	maybeRegistryRoot: unknown,
): maybeRegistryRoot is CommonRegistryRoot {
	return (
		!!maybeRegistryRoot &&
		typeof maybeRegistryRoot === "object" &&
		(maybeRegistryRoot as CommonRegistryRoot).type === "commonroot"
	);
}
...
export function isRegistry(
	maybeRegistry: unknown,
): maybeRegistry is CommonRegistry {
	return (
		!!maybeRegistry &&
		typeof maybeRegistry === "object" &&
		(maybeRegistry as CommonRegistry).type === "commonregistry"
	);
}
...
export function isRepository(
	maybeRepository: unknown,
): maybeRepository is CommonRepository {
	return (
		!!maybeRepository &&
		typeof maybeRepository === "object" &&
		(maybeRepository as CommonRepository).type === "commonrepository"
	);
}
...
export function isTag(maybeTag: unknown): maybeTag is CommonTag {
	return (
		...
		(maybeTag as CommonTag).type === "commontag"
	);
}
...
export function isError(maybeError: unknown): maybeError is CommonError {
	return (
		...
		(maybeError as CommonError).type === "commonerror"
	);
}
