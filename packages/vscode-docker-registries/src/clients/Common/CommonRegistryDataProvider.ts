...
export abstract class CommonRegistryDataProvider
	implements RegistryDataProvider<CommonRegistryItem>, vscode.Disposable
{
	...
	public async getChildren(
		...
		try {
			if (!element) {
				...
				throw new Error(
					`Unexpected element: ${JSON.stringify(element)}`,
				);
			}
		} catch (error: unknown) {
